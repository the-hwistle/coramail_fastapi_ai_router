        ...
        rows.append(
            {
                ...
                "Classification": email.get("business_label") or category_label(classification.get("mail_category")),
                "Receiver": email.get("routing_display") or route_label(classification.get("routing_labels")),
...
def render_inbox(emails: list[dict[str, Any]]) -> None:
    ...
    with left:
        ...
        st.markdown(chip(email.get("business_label") or category_label(classification.get("mail_category")), "red"), unsafe_allow_html=True)
